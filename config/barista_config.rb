...
Barista.configure do |c|
  ...
  c.register :tests, :root => Rails.root.join('vendor', 'assets', 'javascripts'), :output_prefix => 'vendor'

  c.register :tests, :root => Rails.root.join('spec', 'javascripts', 'models'), :output_prefix => 'models'
  c.register :tests, :root => Rails.root.join('spec', 'javascripts', 'views'), :output_prefix => 'views'
  c.register :tests, :root => Rails.root.join('spec', 'javascripts', 'controllers'), :output_prefix => 'controllers'
  
  c.register :tests, :root => Rails.root.join('spec', 'javascripts'), :output_prefix => 'test'
